...
int main(int argc, char **argv) {
    ...
    if (args.gameparams) opts.gameparams_path = args.gameparams;
    if (args.assets_bin) opts.assets_bin_path = args.assets_bin;
    if (args.hull)       opts.hull_upgrade    = args.hull;
